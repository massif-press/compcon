  ...
  >
    ...
    >
      <v-card-text>
        ...
        <cc-chip
          v-for="(game, gameIdx) in itch.gamedata"
          :key="`game-${gameIdx}`"
          bg-color="primary"
          color="accent"
          variant="elevated"
          ...
          class="ma-1"
        />
        <div class="mt-2">{{ $t('mainMenu.itch.eligibleUpdates') }}:</div>
        <v-card
          flat
          border
        >
          ...
          <div class="text-center py-2">
            <i18n-t
              keypath="mainMenu.itch.manageContentHint"
              tag="span"
              scope="global"
            >
              <template #link>
        ...
        >
          <div>
            ...
            <div class="text-caption">
              <i18n-t
                keypath="mainMenu.itch.updateHint"
                tag="span"
                scope="global"
              >
                <template #update>
