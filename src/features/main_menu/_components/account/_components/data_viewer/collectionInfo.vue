  ...
  >
    <v-col cols="3">
      ...
      <div class="text-caption">
        {{ $t('mainMenu.collection.byAuthor', { author: collection.author }) }}
      </div>
      <div class="text-caption">
    ...
    <v-col>
      ...
      <v-table density="compact">
        ...
        <tbody>
          <tr
            v-for="(content, contentIdx) in JSON.parse(collection.contents)"
      ...
      <v-table density="compact">
        ...
        <tbody>
          <tr
            v-for="(content, contentIdx) in sortedChangelog(collection.changelog)"
            :key="`changelog-${contentIdx}`"
          >
