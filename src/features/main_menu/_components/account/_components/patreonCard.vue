          ...
          <v-row>
            ...
            <v-col>
              <div class="heading h3 text-center text-accent">
                <b>
                  {{
                    $t('mainMenu.patreon.tierSuffix', { title: patreon.profile?.tierData.title })
                  }}
                </b>
              </div>
              <div>
      ...
      >
        <v-row dense>
          <v-col
            cols="12"
            lg="3"
            class="heading text-accent pr-3"
          >
            {{ t.title }}
          </v-col>
          <v-col>
            <div
              v-for="(b, bIdx) in t.benefits"
              :key="`benefit-${bIdx}`"
            >
              <v-icon
