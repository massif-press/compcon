  ...
  <div>
    ...
    >
      ...
      >
        <div>
          <i18n-t
            keypath="mainMenu.storage.iosWarning"
            tag="span"
            scope="global"
          >
            <template #emphasis>
              <b>{{ $t('mainMenu.storage.autoDeleteData') }}</b>
            </template>
          </i18n-t>
          :
        </div>
        <ol class="mt-2 ml-4">
          <li>
            <i18n-t
              keypath="mainMenu.storage.iosStep1"
              tag="span"
              scope="global"
            >
              <template #share>
          ...
          <li>
            <i18n-t
              keypath="mainMenu.storage.iosStep2"
              tag="span"
              scope="global"
            >
              <template #target>
                <b>{{ $t('mainMenu.storage.addToHomeScreen') }}</b>
              </template>
            </i18n-t>
          </li>
          <li>
            <i18n-t
              keypath="mainMenu.storage.iosStep3"
              tag="span"
              scope="global"
            >
              <template #target>
    ...
    >
      ...
      >
        <div v-if="!hasStorage">
          <i18n-t
            keypath="mainMenu.storage.noStorageWarning"
            tag="span"
            scope="global"
          >
            <template #recommended>
              <b>{{ $t('mainMenu.storage.stronglyRecommended') }}</b>
            </template>
            <template #pwaLink>
              <a
        ...
        <div v-else>
          <i18n-t
            keypath="mainMenu.storage.v3StorageWarning"
            tag="span"
            scope="global"
          >
            <template #permission>
              <b>{{ $t('mainMenu.storage.persistentStoragePermission') }}</b>
            </template>
          </i18n-t>
        </div>
        <div
