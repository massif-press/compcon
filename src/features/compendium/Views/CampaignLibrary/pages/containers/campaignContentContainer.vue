  ...
  <div class="my-1">
    ...
    >
      ...
      <narrative-content
        ...
        :data="item.AsNarrative.Data"
      />
      <encounter-content
        v-else-if="item.ContentType === 'encounter'"
        :data="item.AsEncounter.Data"
      />
      <v-card-text v-else>
        <v-row dense>
          <v-col
            v-if="item.Variant === 'quote'"
            cols="auto"
          >
            <div
              class="rounded bg-panel pa-1 mx-2"
              style="height: 100%"
            />
          </v-col>
          <v-col>
