    ...
    <div>
      <v-container grid-list-lg class="mt-0 pt-0">
        ...
        <v-row align="center">
          ...
          <v-col cols="auto" class="heading h6"> Reference </v-col>
          <v-col>
            <v-divider />
          </v-col>
        </v-row>
