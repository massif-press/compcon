<template>
  <v-container v-if="!layers.length" class="px-12">
    <v-alert icon="cc:monist" title="No Eidolon Data" variant="tonal">
      <p>
        <strong>Eidolons</strong> are complex and otherworldly enemies meant to provide a unique,
        puzzle-like combat experience. They are fearsome foes that, at their most powerful, are more
        than the match for a whole group of lancers.
      </p>
      <br />
      <p>
