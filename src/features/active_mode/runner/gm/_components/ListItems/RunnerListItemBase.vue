            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <v-img
                    v-if="portrait && layout.showPortraits"
                    height="100%"
                ...
                >
                          ...
                          <template #activator="{ props }">
                            ...
                            >
                              ...
                              <span
                                ...
                                class="text-cc-overline text-disabled mr-1"
                              >
                                {{ stat.title }}
                              </span>
                              <b class="text-accent">
                  ...
                  <div
                    v-else-if="!destroyed && !outOfCombat && (reinforcementTurn || isReinforcement)"
                  >
                    <v-card
                      flat
                      tile
                    ...
                    <div class="">
                      <cc-button
                        v-if="!timeToDeploy || timeToDeploy < 1"
                        block
                        color="success"
                        size="x-small"
                  ...
                  <v-row
                    v-if="!infoless && actor.CombatController.Resistances.length > 0"
                      ...
                      <template #activator="{ props }">
                        ...
                        >
                          <v-icon
                            v-if="layout.showIcon"
                            :icon="
                              isDamageType(damage.type)
                                ? `cc:${damage.type.toLowerCase()}`
                                : 'mdi-shield-outline'
                            "
                  ...
                  <v-card
                    v-if="!infoless && actor.CombatController.Cover !== 'none'"
                    flat
                    tile
                    class="px-2 ma-1"
                    color="surface-variant"
                  ...
                  <template v-if="!infoless">
                    <div
                      v-for="(cs, index) in customStatuses"
                      :key="`custom-${index}`"
                      class="d-flex"
                    >
                      <v-tooltip
...
<script setup lang="ts">
  ...
  const infoless = computed(() => {
    return (
      destroyed.value || props.outOfCombat || !!props.reinforcementTurn || props.isReinforcement
    )
  })
