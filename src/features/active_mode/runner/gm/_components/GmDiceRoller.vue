  ...
  <v-card min-height="500px">
        ...
        >
          ...
          <v-col>
            <v-btn
              ...
              @click="setCheck('Agi')"
            >
              {{ $t('active.diceRoller.agilityCheck') }}
            </v-btn>
          </v-col>
          <v-col>
            <v-btn
              ...
              @click="setCheck('Sys')"
            >
              {{ $t('active.diceRoller.systemsCheck') }}
            </v-btn>
          </v-col>
          <v-col>
            <v-btn
              ...
              @click="setCheck('Eng')"
            >
              {{ $t('active.diceRoller.engineeringCheck') }}
            </v-btn>
          </v-col>
        </v-row>
      </div>
    ...
    <v-card-text class="pb-0">
      <v-row dense>
        <v-col cols="auto">
          <v-card
            class="text-text text-cc-overline"
            flat
          >
