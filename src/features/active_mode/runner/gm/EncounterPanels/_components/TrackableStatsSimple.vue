<template>
  ...
  <v-row dense>
    ...
    >
      <simple-mini-panel
        v-model.number="item.StatController.CurrentStats['overshield']"
  ...
  >
    <v-col>
      <simple-mini-panel
        v-model.number="item.StatController.CurrentStats['overcharge']"
        :max="3"
      ...
      />
      <simple-mini-panel
        v-model.number="item.StatController.CurrentStats['stress']"
  ...
  <v-row>
    <v-col md="">
      ...
      <v-row
        v-if="item.StatController.MaxStats['overcharge']"
        no-gutters
        align="center"
        class="bg-panel p5-1"
      >
        ...
        >
          <v-rating
            v-model="item.StatController.CurrentStats['overcharge']"
            color="overcharge"
      ...
      >
        {{
          item.CombatController.CorePower
            ? $t('active.trackable.corePowerReady')
