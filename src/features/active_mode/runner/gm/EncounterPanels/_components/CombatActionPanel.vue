<template>
  <div>
    ...
    <v-row dense>
      ...
      <v-col>
        <v-card :color="!controller.CanActivate('full') ? 'grey' : 'action--full'"
          flat
          tile
          class="text-center py-1 px-2"
      ...
      <v-col>
        <v-card :color="!controller.CombatActions.Quick1 ? 'grey' : 'action--quick'"
          flat
          tile
          class="text-center py-1 px-2"
      ...
      <v-col>
        <v-card :color="!controller.CombatActions.Quick2 ? 'grey' : 'action--quick'"
          flat
          tile
          class="text-center py-1 px-2"
      ...
      <v-col>
        <v-card :color="!controller.CanActivate('move') ? 'grey' : 'action--move'"
          flat
          tile
          class="text-center py-1 px-2">
          <v-icon size="large"
      ...
      <v-col v-if="!hideOvercharge">
        <v-card :color="!controller.CanActivate('overcharge') ? 'grey' : 'overcharge'"
          flat
          tile
          class="text-center py-1 px-2"
      ...
      <v-col>
        <v-card :color="!controller.CanActivate('reaction') ? 'grey' : 'action--reaction'"
          flat
          tile
          class="text-center py-1 px-2"
