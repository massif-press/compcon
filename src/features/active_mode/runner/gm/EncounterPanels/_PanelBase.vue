<template>
  ...
  >
    <div
      class="heading h2 pa-1 mr-n12 ml-n4 text-error"
      ...
      >
        <v-row class="pr-4">
          ...
          <v-col>
            ...
            >
              <v-col
                v-if="item.CombatController.StatController.SizeIcon"
                cols="auto"
                align-self="center"
                class="ml-n2 mr-2"
              >
                <v-icon
                  :icon="item.CombatController.StatController.SizeIcon"
                  size="60"
                />
              </v-col>
              <v-col>
                ...
                >
                  <template #activator="{ props }">
                    ...
                    >
                      ...
                      >
                        {{ (item as any).Grit || (item as any).Parent?.Grit || 0 }}
                      </span>
                    </span>
                  </template>
                </cc-tooltip>
