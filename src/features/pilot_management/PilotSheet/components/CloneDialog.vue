  ...
  >
    <v-card-text>
      <v-row>
        <v-col>
          <div
            class="text-center body-text light-panel pa-2"
            style="border-radius: 3px"
          >
            Duplicating or Cloning a pilot will remove any Vault links, saving
            the copied Pilot as a new character on your account
          </div>
        </v-col>
      </v-row>
      <v-row density="compact" justify="space-around">
        <v-col cols="5" class="text-center">
          ...
          >
            <v-btn large block color="primary" @click="copyPilot"
