  ...
  <div :class="mobile ? 'px-4' : 'px-12'">
    ...
    <div v-else>
      ...
      <div v-if="pilot.BondController.Bond">
        ...
        >
          ...
          >
            ...
            <ul>
              <li
                v-for="(m, index) in pilot.BondController.Bond.MajorIdeals"
                :key="`ideal-${index}`"
                v-text="m"
              />
            </ul>
            ...
            >
              <legend>
                <span class="px-2 heading h4 text-accent">
                  {{ $t('pm.sheet.bondPowersAvailable') }}
                </span>
              </legend>
              <div
      ...
      <div v-if="hasBond">
        ...
        <div>
          <div
            v-for="(b, i) in pilot.BondController.Burdens"
            :key="`burden-${i}`"
          >
            <cc-clock
              :clock="b"
...
<script setup lang="ts">
  ...
  onMounted(() => {
    masonryBondItems.value = sortBy(
      [...props.pilot.BondController.BondPowers],
      ['master', 'veteran', 'origin', 'name']
    ).reverse()
  })
</script>
