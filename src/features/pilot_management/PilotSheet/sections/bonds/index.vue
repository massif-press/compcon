  ...
  <v-container v-else>
    <div style="padding-right: 225px">
      ...
      <div v-else class="heading h1">
        <v-btn size="x-large" block color="primary" @click="($refs as any).choosebond.show()">
    ...
    <v-divider class="mb-3 mt-6" style="margin-right: 225px !important" />
    ...
    <v-row justify="end">
      <v-col cols="auto">
        <v-btn text x-small class="fade-select" @click="pilot.BondController.AddNewBurden()">
          Add New Burden
        </v-btn>
      </v-col>
    </v-row>
    ...
    <v-container v-if="hasBond">
      <v-row justify="center">
        <v-col v-for="(p, i) in pilot.BondController.BondPowers" xl="6" lg="6" sm="12">
    ...
    <bond-power-selector v-if="hasBond" :pilot="pilot" @set="setBond($event)" />
