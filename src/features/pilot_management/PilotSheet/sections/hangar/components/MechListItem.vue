<template>
  ...
  >
    <template #default="{ contentMargin }">
      ...
      >
        <div
          :style="`margin-left: ${contentMargin}px; margin-top: -1px; padding-left: 8px; min-height: 100px`"
        >
            ...
            >
                ...
                <fieldset class="px-3">
                  ...
                  >
                    ...
                    >
                      ...
                      <cc-slashes
                        v-if="i + 1 < loadoutWeapons.length"
                        class="px-2"
                      />
                    </span>
                    <br />
              ...
              >
                <v-tooltip
                  location="top"
                  :text="
                    mech.Parent.FavoriteMech?.ID === mech.ID ? 'Unfavorite Mech' : 'Favorite Mech'
                  "
                >
                  <template #activator="{ props }">
                    ...
                    >
                      <v-icon
                        size="22"
                        :icon="
                          mech.Parent.FavoriteMech?.ID === mech.ID ? 'mdi-star' : 'mdi-star-outline'
                        "
                      />
                    </v-btn>
                  </template>
