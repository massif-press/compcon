...
<script setup lang="ts">
  ...
  const itemTitle = computed(() => {
    ...
    if (props.item.Name !== props.item.TrueName)
      return `${props.item.Name} (${props.item.TrueName})`
