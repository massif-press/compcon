  ...
  <v-container fluid>
    ...
    >
      ...
      <v-col class="text-center">
        ...
        <v-icon size="30" color="grey lighten-2" class="mr-n1 mt-n3"
      ...
      <div v-for="(w, j) in m.Weapons" v-else class="px-1">
        ...
        <div v-for="p in w.Profiles">
          <div class="caption">
            ...
            <p
              v-if="p.OnAttack"
              :v-html-safe="`<b>ON ATTACK:</b> ${p.OnAttack}`"
              print
            />
            <p
              v-if="p.OnHit"
              :v-html-safe="`<b>ON HIT:</b> ${p.OnHit}`"
              print
            />
            <p
              v-if="p.OnCrit"
              :v-html-safe="`<b>ON CRIT:</b> ${p.OnCrit}`"
              print
            />
