  ...
  >
    ...
    >
      ...
      >
        ...
        <v-col
          v-if="(d as any).MaxHP || (d as any).Size"
          cols="auto"
        >
          <div
            v-html-safe="
        ...
        <v-col
          v-if="(d as any).EDefense"
          cols="auto"
        >
          <div
            v-html-safe="`<b>E-Defense:</b> ${(d as any).EDefense}`"
            class="caption"
          />
        </v-col>
        <v-col
        ...
        <v-col
          v-if="(d as any).Sensors"
          cols="auto"
        >
          <div
            v-html-safe="`<b>Sensor Range:</b> ${(d as any).Sensors}`"
            class="caption"
          />
        </v-col>
        <v-col
          v-if="(d as any).TechAttack"
          cols="auto"
        >
          <div
            v-html-safe="`<b>Tech Attack:</b> ${(d as any).TechAttack}`"
            class="caption"
          />
        </v-col>
        <v-col
