  ...
  <div class="text-black px-2">
    ...
    <v-row class="mt-n3 print-section">
      <v-col>
        ...
        >
          <v-col cols="auto">
            <div class="text-uppercase font-weight-bold text-primary mb-n3">
              {{ $t('pm.print.pilotHP') }}
            </div>
            <v-row
              v-if="blank"
        ...
        >
          <v-col>
            <v-row class="text-center">
              ...
              <v-col>
                <div class="text-uppercase font-weight-bold text-primary mb-n2 text-primary">
                  {{ $t('stats.agility') }}
                </div>
                <blank-line
                  v-if="blank"
        ...
        <div>
          <div
            v-if="hasPilotOption('appearanceNotes')"
            class="mt-1"
          >
          ...
          <div
            v-if="blank || pilot.History.length > 0"
            class="mt-1"
          >
    ...
    >
      <v-col>
        ...
        <template v-else-if="hasPilotOption('separateTalentDetail')">
          <v-chip
