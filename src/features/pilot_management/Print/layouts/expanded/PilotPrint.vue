<template>
  <div class="text-black px-2">
    ...
    <fieldset
      v-if="hasPilotOption('expandedMissionLog')"
    ...
    <v-row align="center">
      ...
      <v-col>
        ...
        >
          ...
          <v-col>
            <div class="font-weight-bold caption text-primary mb-n3">
              {{ $t('stats.edefense') }}
            </div>
            <v-icon
              v-if="blank"
        ...
        >
          ...
          <v-col>
            <div class="font-weight-bold caption text-primary mb-n2 text-primary">
              {{ $t('stats.agility') }}
            </div>
            <blank-line
              v-if="blank"
    ...
    <v-row
      v-if="hasPilotOption('extraEquipmentSpace')"
      dense
      justify="space-between"
  ...
  <div
    v-if="!blank && pilot.ReservesController.Reserves.length"
  ...
  >
    <div class="text-caption mb-n2 mt-1 text-primary">{{ $t('common.reserves') }}</div>
    <fieldset
      v-for="r in hasPilotOption('extraReserveSpace') ? 9 : 6"
      :key="`reserve-${r}`"
      class="mt-2"
      style="position: relative"
    >
  ...
  <fieldset
    v-if="hasPilotOption('appendLined')"
  ...
  <fieldset
    v-if="hasPilotOption('appendUnlined')"
    class="mx-1 my-3 px-3 no-print-break"
  >
    <div class="mb-4">
      <notes :rows="48" />
  ...
  <div v-if="hasPilotOption('separateTalentDetail')">
    <div
      v-for="t in pilot.TalentsController.Talents"
      :key="t.Talent.ID"
      dense
