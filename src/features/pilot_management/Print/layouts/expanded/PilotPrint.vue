  ...
  <div class="text-black px-2">
      ...
      <v-col>
        ...
        <div class="mt-2">
          <div class="text-overline text-primary"
            style="line-height: 0">BIOGRAPHY</div>
        ...
        <div class="mt-2">
          <div class="text-overline text-primary"
            style="line-height: 0">APPEARANCE</div>
          <div v-if="blank"
            class="mb-4">
            <notes :rows="5"
              lined />
    ...
    <fieldset class="pa-1">
      ...
      <v-row no-gutters
        ...
        <v-col cols="2">
          <div class="text-overline text-primary"
            style="line-height: 0">SESSION</div>
        ...
        <v-col>
          <div class="text-overline text-primary"
            style="line-height: 0">DETAIL</div>
          <blank-line :height="450"
            class="mt-3" />
        </v-col>
      </v-row>
      ...
      <v-col v-for="a in pilot.Loadout.Armor.filter((x) => x)"
        ...
        <fieldset v-if="a">
          <legend class="heading h3 ml-1 px-1">
            ...
            <span v-else
              class="text-grey">Pilot Armor</span>
          </legend>
          <div v-if="blank"
            style="height: 150px" />
          <div v-else>
      ...
      <v-col v-for="w in pilot.Loadout.Weapons.filter((x) => x)"
        ...
        <fieldset v-if="w || blank">
          <legend class="heading h3 ml-1 px-1">
            ...
            <span v-else
              class="text-grey">Pilot Weapon</span>
          </legend>
          <div v-if="blank"
            style="height: 150px" />
          <div v-else>
      ...
      <v-col v-for="g in pilot.Loadout.Gear.filter((x) => x)"
        ...
        <fieldset v-if="g || blank">
          <legend class="heading h3 ml-1 px-1">
            ...
            <span v-else
              class="text-grey">Pilot Gear</span>
          </legend>
          <div v-if="blank"
            style="height: 150px" />
          <div v-else
