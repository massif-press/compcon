  ...
  <div class="text-black px-2">
    ...
    <v-row dense
      ...
      <v-col v-if="mech.Armor"
        ...
        <div v-else
          class="heading ph2 mr-n2 text-primary"
          :class="'mt-n2'">
          <v-icon size="35"
            class="mt-n1 mr-n1"
            style="opacity: 0.6">
      ...
      <v-col cols="auto"
        class="text-center">
        <div style="line-height: 10px"
          class="text-overline text-primary mb-4 mr-2">
          {{ $t('stats.stress') }}
        </div>
        <v-row v-if="blank"
          dense
    ...
    <v-row dense>
      <v-col :cols="hasMechOption('mechImage') ? (landscape ? 9 : 8) : 12">
        ...
        <div v-if="hasMechOption('mechNotes') && mech.Notes && !blank"
          class="pt-2">
      ...
      <v-col v-if="hasMechOption('mechImage')"
        cols="4"
        class="mt-5">
        <v-card height="100%"
          variant="outlined"
    ...
    <div v-if="hasMechOption('mechNotes') && blank"
      class="pt-3">
    ...
    <print-blank-loadout v-if="blank"
      :extra-mounts="hasMechOption('extraMountPanel')"
      :line-height="20"
        ...
        <v-row dense>
          ...
          <v-col>
            <span class="text-cc-overline">
              {{ w.Source }} {{ $enum('weaponSize', w.Size) }}
    ...
    <print-blank-systems v-if="blank"
      :extra-system-space="hasMechOption('extraSystemSpace')"
      :line-height="20"
      :slot-height="landscape ? 40 : 64" />
    ...
    <fieldset v-if="hasMechOption('appendLined')"
    ...
    <fieldset v-if="hasMechOption('appendUnlined')"
      class="mx-1 my-3 px-3 no-print-break">
      <div class="mb-4">
        <notes :rows="16" />
      </div>
