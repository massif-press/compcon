<template>
  ...
  <v-row dense>
    ...
    <v-col class="ml-4">
      <v-row
        class="border-sm text-center my-1"
  ...
  <div v-if="mech">
    ...
    <v-row dense>
      ...
      <v-col>
        ...
        <div class="d-flex flex-wrap justify-center">
          <cc-item-modal
            v-for="(w, index) in mech.MechLoadoutController.ActiveLoadout.Weapons"
            :key="`weapon-${index}`"
            :item="w"
          />
        </div>
        ...
        <div class="d-flex flex-wrap justify-center">
          <cc-item-modal
            v-for="(s, index) in mech.MechLoadoutController.ActiveLoadout.Systems"
            :key="`system-${index}`"
            :item="s"
          />
        </div>
