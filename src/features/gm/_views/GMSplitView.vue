...
<script setup lang="ts">
  ...
  function emitAddNew(isActive: { value: boolean }) {
    emit('add-new')
    isActive.value = false
  }

  function emitOpenImport(isActive: { value: boolean }) {
    emit('open-import')
    isActive.value = false
  }
