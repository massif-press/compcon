<template>
  <v-container>
              ...
              <v-row class="my-2">
                ...
                <v-col>
                  <v-card variant="outlined">
                    <v-img
                      :src="bannerPreview || campaign.BannerImageUrl"
                      height="100"
                    />
                  </v-card>
                </v-col>
    ...
    <div
      class="text-center my-1 mx-auto"
      style="width: 80%"
    >
      <cc-short-string-editor
        large
        @set="campaign.Title = $event"
      >
      ...
      <v-col>
        <div>
          ...
          >
            ...
            <v-col cols="auto">
              <span class="text-lowercase">{{ $t('active.joinTable.players') }}</span>
            </v-col>
          </v-row>
            ...
            <v-card-text>
              ...
              <v-row class="my-2">
                ...
                <v-col>
                  <v-card variant="outlined">
                    <v-img
                      :src="coverPreview || campaign.CoverImageUrl"
                      height="100"
                      cover
                    />
                  </v-card>
    ...
    <div v-if="campaign.VersionHistory && campaign.VersionHistory.length">
      ...
      <fieldset style="border-radius: 3px">
        ...
        <div
          v-for="(hist, index) in campaign.VersionHistory"
          :key="`hist-${index}`"
          class="px-4 py-2"
        >
...
<script setup lang="ts">
  ...
  function deleteHistory(hist: unknown) {
    props.campaign.VersionHistory.splice(props.campaign.VersionHistory.indexOf(hist as never), 1)
    props.campaign.save()
  }
