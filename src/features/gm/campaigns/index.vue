          ...
          <v-row align="center">
            ...
            <v-col>
              ...
              <div class="text-caption">
                <i>
                  {{
                    $t('gm.campaign.versionLabel', {
                      version: c.Version || $t('gm.campaign.unpublished'),
                    })
                  }}
                </i>
              </div>
          ...
          <v-card>
            ...
            <v-card-text>
              <p class="text-caption text-center">
                <i>
                  <i18n-t
                    keypath="gm.campaign.importHelp"
                    tag="span"
                    scope="global"
                  >
                    <template #jsonFile>
                      <b class="text-secondary">{{ $t('gm.campaign.jsonFile') }}</b>
                    </template>
                    ...
                    <template #manageContent>
                      <b>{{ $t('common.manageContent') }}</b>
                    </template>
                  </i18n-t>
                </i>
              </p>
                    ...
                    >
                      ...
                      {{
                        $t('common.importOverwriteWarning', {
                          ...
                          date: new Date(importSameId.SaveController.LastModified).toLocaleString(),
                        })
                      }}
                    </v-alert>
