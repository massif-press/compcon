<template>
  <div
    v-if="readonly && item.NpcTemplateController.Templates.length === 0"
    class="mb-6"
  >
    <v-card flat>
  ...
  <v-row align="center">
    <v-col
      v-if="item.NpcTemplateController.Templates.length"
      cols="auto"
      dense
      align="center"
    >
    ...
    >
      ...
      >
        {{
          item.NpcTemplateController.Templates.length
            ? $t('gm.npcTemplate.editTemplates')
  ...
  >
    ...
    >
      ...
      <template #item="{ item: template }">
        ...
        <cc-button
          v-else-if="templateConflict(template).length"
          size="small"
          block
          disabled
        >
