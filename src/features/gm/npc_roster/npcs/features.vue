  ...
  <div v-if="npc.NpcClassController?.HasClass">
            ...
            <v-menu :close-on-content-click="false">
              ...
              >
                ...
                >
                  ...
                  <cc-text-area
                    v-model="item.FlavorDescription"
    ...
    >
      <template #item="{ element }">
        <div
          class="feature-reorder-row mb-2"
        ...
        >
          ...
          <div style="flex: 1; min-width: 0">
            ...
            >
              <template #pre>
                <npc-mod-inset
                  v-for="mod in npc.NpcFeatureController.GetModifiers(<NpcFeature>element)"
                  :key="mod.ID"
                  :mod="mod"
                />
              </template>
...
<script setup lang="ts">
  ...
  // stored order is authoritative: it is what reorder mode edits and what print renders
  const shownFeatures = computed(() =>
    showPassives.value ? allFeatures.value : allFeatures.value.filter((f: any) => !f.Passive)
  )
