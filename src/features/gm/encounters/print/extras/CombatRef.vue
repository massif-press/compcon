<template>
  <div class="pa-2 mt-3">
    <div class="text-overline text-primary"
      style="line-height: 15px">COMBAT REFERENCE</div>
    <fieldset class="px-2">
      ...
      <v-row dense>
        <v-col>
          <v-card variant="outlined"
            ...
            class="text-center"><v-icon size="large"
              icon="cc:protocol" />
        ...
        <v-col cols="4">
          <v-card variant="outlined"
            ...
            <v-icon size="large"
              color="indigo lighten-3">mdi-swap-horizontal</v-icon>
            <v-icon size="large"
      ...
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="caption">
            ...
            <b>ENGAGED</b> receive <v-icon icon="cc:difficulty"
              class="mt-n1 ml-n1" />.
          </div>
          <div class="caption">
    ...
    <v-row dense
      ...
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="caption">
            Each point of <v-icon icon="cc:accuracy"
              class="mt-n1 mx-n1" /> adds 1d6 to a roll.
          </div>
          <div class="caption">
            Each point of <v-icon icon="cc:difficulty"
              class="mt-n1 mx-n1" /> subtracts 1d6 from a
            roll.
          </div>
          <div class="caption">
            <v-icon icon="cc:accuracy"
              class="mt-n1 mx-n1" /> and
            <v-icon icon="cc:difficulty"
              class="mt-n1 mx-n1" /> cancel each other out on a 1:1
            basis. No roll can ever receive more than -6 or +6 from
            <v-icon icon="cc:accuracy"
              class="mt-n1 mx-n1" /> or
            <v-icon icon="cc:difficulty"
              class="mt-n1 mx-n1" />.
          </div>
        </fieldset>
      ...
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="caption">
            <b>Soft cover</b>, adds +1 <v-icon icon="cc:difficulty"
              class="mt-n1 mx-n1" /> to any
            ranged attacks.
          </div>

          <div class="caption">
            <b>Hard cover</b> adds +2 <v-icon icon="cc:difficulty"
              class="mt-n1 mx-n1" /> to any
            ranged attacks. Characters only benefit from hard cover if they are adjacent to whatever
            they’re using for cover and are the same <b>SIZE</b> or smaller.
          </div>
    ...
    <v-row dense>
      <v-col cols="auto">
        <fieldset class="px-2">
          <legend class="text-overline text-primary px-2 mb-n2 font-weight-bold">
            SKIRMISH <v-icon icon="mdi-hexagon-slice-3"
              color="action--quick" />
          </legend>
      ...
      <v-col cols="auto">
        <fieldset class="px-2">
          <legend class="text-overline text-primary px-2 mb-n2 font-weight-bold">
            BARRAGE <v-icon icon="mdi-hexagon-slice-6"
              color="action--full" />
          </legend>
          <div class="caption">
      ...
      <v-col cols="auto">
        <fieldset class="px-2">
          <legend class="text-overline text-primary px-2 mb-n2 font-weight-bold">
            IMPROVISED ATK. <v-icon icon="mdi-hexagon-slice-6"
              color="action--full" />
          </legend>
          <div class="caption">
            Deal 1d6 <v-icon icon="cc:kinetic"
    ...
    <v-row dense
      ...
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="text-center">
            <v-chip size="x-small"
              class="mt-n1"
              color="action--full"><v-icon icon="mdi-dice-d20"
                start /> + GRIT vs EVASION</v-chip>
          </div>
          <div class="caption text-center">
            Target within <v-icon icon="cc:threat"
              class="mt-n1 ml-n1" /><b>THREAT</b> and
            <b>LOS</b>
          </div>
        </fieldset>
      </v-col>
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="caption text-center">
            Target within <v-icon icon="cc:range"
              class="mt-n1 ml-n1" /><b>RANGE</b> and
            <b>LOS</b>
          </div>
        </fieldset>
      </v-col>
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="text-center">
            <v-chip size="x-small"
              class="mt-n1"
              color="action--tech"><v-icon icon="mdi-dice-d20"
                start /> + TECH ATK. vs E-DEF</v-chip>
          </div>
          <div class="caption text-center">
            Target within <v-icon icon="cc:sensor"
              class="mt-n1" /><b>SENSORS</b> and
            <b>LOS</b>
          </div>
        </fieldset>
      </v-col>
