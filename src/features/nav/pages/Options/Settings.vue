<template>
  <v-container :class="!mobile && 'px-12'">
    ...
    >
      ...
      <v-col cols="auto">
        <cc-switch
          ...
          :label="$t('nav.settingsPage.showExoticsLabel')"
        ></cc-switch>
        <br />
        <cc-switch
    ...
    <v-row dense>
      ...
      >
        <div>
          ...
          <i
            v-if="themes.find(x => x.id === theme)?.category === 'Community Theme'"
            class="text-caption"
            style="opacity: 0.75"
          >
            <i18n-t
              keypath="nav.settingsPage.communityThemesBy"
              tag="span"
              scope="global"
            >
              <template #vialra>
              ...
              <template #thecrystalwoods>
                ...
                >
                  {{ themeContributors.thecrystalwoods }}
                </a>
              </template>
              <template #suji>
                <a
        ...
        <div>
          ...
          />
          <div
            v-if="showLanguageNote"
            class="text-center"
          >
            <div
              v-for="comp in TRANSLATION_COMPONENTS"
              :key="comp"
              class="mt-1"
            >
              ...
              <v-progress-linear
                :model-value="componentPct(comp, language)"
              ...
              >
                ...
                >
                  <v-icon
                    ...
                    :color="getTransColor(comp, language)"
                    :icon="
                      getTransColor(comp, language) === 'success'
                        ? 'mdi-check-outline'
                        : getTransColor(comp, language) === 'warning'
            ...
            <div
              class="text-caption text-disabled font-italic pt-1"
              style="line-height: 1"
            >
          ...
          <v-row v-if="user.ErrorReporting">
            ...
            <v-col cols="auto">
              ...
              >
                ...
                <i18n-t
                  keypath="nav.settingsPage.enhancedReportingTooltip"
                  tag="span"
                  scope="global"
                >
                  <template #nonAnon>
                    <strong class="text-accent">
                      {{ $t('nav.settingsPage.enhancedReportingPiiNote') }}
                    </strong>
                  </template>
                  <template #notNecessary>
                    <strong class="text-accent">
                      {{ $t('nav.settingsPage.enhancedReportingNotNecessary') }}
                    </strong>
                  </template>
                </i18n-t>
              </v-tooltip>
    ...
    <v-row class="mt-4">
      ...
      >
        <cc-dialog
          :title="$t('nav.settingsPage.loadBackup')"
