  ...
  <v-container :class="!mobile && 'px-12'">
            ...
            <template #activator="{ props }">
              ...
              >
                <v-list-item-subtitle>
                  ...
                  <span class="text-disabled ml-2">
                    {{ sessionTime(selectedSession?.startedAt) }}
                  </span>
                </v-list-item-subtitle>
                <template #append>
                  <v-icon>mdi-chevron-down</v-icon>
    ...
    <v-card-actions>
      ...
      <v-menu>
        ...
        <cc-confirmation
          cancellable
          :content="$t('nav.log.clearAllLogsConfirm')"
...
<script setup lang="ts">
  ...
  function clearAllLogs() {
    logger.clearAll()
    selectedSessionId.value = logger.Sessions[0]?.id ?? ''
    tick.value++
  }
