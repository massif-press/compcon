          ...
          <v-card-text>
            ...
            >
              <v-col
                ...
                cols="auto"
              >
                <cc-tooltip :text="$t('ui.tooltips.addCoinFlipD2')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col
                ...
                cols="auto"
              >
                <cc-tooltip :text="$t('ui.tooltips.addD4Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col cols="auto">
                <cc-tooltip :text="$t('ui.tooltips.addD6Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col
                ...
                cols="auto"
              >
                <cc-tooltip :text="$t('ui.tooltips.addD8Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col
                ...
                cols="auto"
              >
                <cc-tooltip :text="$t('ui.tooltips.addD10Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col
                ...
                cols="auto"
              >
                <cc-tooltip :text="$t('ui.tooltips.addD12Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col cols="auto">
                <cc-tooltip :text="$t('ui.tooltips.addD20Roll')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col cols="auto">
                <cc-tooltip :text="$t('ui.tooltips.addAccuracy')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
              ...
              <v-col cols="auto">
                <cc-tooltip :text="$t('ui.tooltips.addDifficulty')">
                  <template #activator="{ props }">
                    <v-btn
                      v-bind="props"
                      icon
            ...
            <div style="min-height: 20px">
              <div v-if="result">
                ...
                >
                  <div class="caption">
                    {{ $t('ui.dice.rolling', { n: r.rolls.length, sides: r.sides }) }}
                  </div>
                  <v-row no-gutters>
                    <v-col
...
<script setup lang="ts">
  ...
  const flat = ref(0)
  const result = ref<
    { sides: number; rolls: number[]; class: string[]; overkill: number }[] | null
  >(null)
