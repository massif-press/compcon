        ...
        <v-row justify="center" align="start">
          <v-col>
            <p class="text--text body-text ma-0">
              Extricate yourself safely from a dangerous situation, make a steady and measured
              retreat, or rely on your mech’s agility to slip in and out of threat ranges faster
              than an enemy can strike. Until the end of your current turn, you ignore engagement
              and your movement does not provoke reactions.
            </p>
          </v-col>
          <v-col cols="auto">
            <v-btn
            ...
            >
              ...
              <cc-tooltip
                inline
                content="Special rules or equipment may allow you to Disengage as a Free Action. Using this button will commit the action without spending a Full Action this turn"
              >
          ...
          <v-row v-if="actionFree || actionFull" no-gutters class="mt-2">
            <v-col cols="auto" class="ml-auto">
              <p class="flavor-text stark--text ma-0">
                ...
                <span>DISENGAGEMENT SUCCESSFUL.</span>
