...
<script setup lang="ts">
  ...
  function updateFilters() {
    ...
    if (attackTypeFilter.value && attackTypeFilter.value.length)
      fObj.RangeType = attackTypeFilter.value
    if (damageTypeFilter.value && damageTypeFilter.value.length)
      fObj.DamageType = damageTypeFilter.value
