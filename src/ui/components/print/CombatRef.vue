    ...
    >
      ...
      <v-col>
        <fieldset class="px-2">
          ...
          <div class="caption">
            <b>20+</b>
            (total) on a melee or ranged attack roll. All damage dice are rolled twice (inc'l bonus
            damage) and the highest result from each is used.
          </div>
        </fieldset>
      </v-col>
    </v-row>
