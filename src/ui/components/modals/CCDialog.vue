  ...
  >
    ...
    >
      ...
      <div v-if="closeOnClick">
        <div class="panel-footer text-center bg-panel">
...
<script setup lang="ts">
  ...
  const VMenuParentChain = Symbol.for('vuetify:v-menu')
  provide(VMenuParentChain, null)
  ...
  watch(
    () => props.modelValue,
    val => {
      if (val !== undefined) dialog.value = !!val
    },
    { immediate: true }
  )
  watch(dialog, val => {
