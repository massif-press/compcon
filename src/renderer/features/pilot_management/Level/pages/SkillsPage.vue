<template>
  ...
  >
    ...
    <v-container class="flavor-text" style="font-size: 14px">
      <span>
        The MV2//a Pilot Self Assessment audit catalogs an individual pilot's self-reported strengths based on selections derived from battlefield telemetry and debrief records analyzed by a Union Naval NHP representative.
        <br />
        <b>NB:</b> The following form is comprised of
        unfiltered output generated by one or more UNI-TACANALYSIS Non-Human Persons and MAY NOT be copied, translated, reproduced, transmitted, or encoded without the express permisson of Union Naval Intelligence.
      </span>
