    ...
    <v-container fluid>
      ...
      <v-layout fill-height justify-space-between>
        ...
        <v-flex class="ml-5">
          <v-layout justify-space-between class="text-xs-center">
            <v-flex class="p-reg">
              <b>HULL</b>
              <br /><span class="p-title font-weight-regular">{{
                config.Hull
              }}</span>
            </v-flex>
            <v-flex class="p-reg">
            ...
            <hr vertical />
            <v-flex class="p-reg">
              <b>ATK</b> BONUS <br /><span
                class="p-title font-weight-regular"
                >{{ signed(config.AttackBonus) }}</span
              >
            </v-flex>
            <v-flex class="p-reg">
              <b>TECH</b> ATK <br /><span class="p-title font-weight-regular">{{
                signed(config.TechAttack)
              }}</span>
            </v-flex>
            <v-flex class="p-reg">
              <b>SAVE</b> TARGET <br /><span
                class="p-title font-weight-regular"
                >{{ config.SaveTarget }}</span
              >
            </v-flex>
          </v-layout>
      ...
      <v-layout justify-space-around class="text-xs-center">
        ...
        <v-flex shrink class="ml-2">
          ...
          <br />
          <v-icon>crop_din</v-icon><v-icon>crop_din</v-icon
          ><v-icon>crop_din</v-icon><v-icon>crop_din</v-icon>
          <br />
                      ...
                      <div v-else v-for="w in mount.Slots" :key="w.id">
                        <v-layout>
                          ...
                          <v-flex shrink class="ml-1" v-if="!w.Weapon.err">
                            ...
                            <span class="p-reg">
                              ({{ w.Weapon.Size }} {{ w.Weapon.Type }})</span
                            >
