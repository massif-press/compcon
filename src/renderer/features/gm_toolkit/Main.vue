  ...
  <v-app id="gm-toolkit" style="padding: 0 !important;">
    ...
    <v-navigation-drawer v-model="drawer" app clipped disable-resize-watcher>
      <v-list>
        ...
        <v-list-tile to="/encounter-builder" active-class="secondary--text">
          <v-list-tile-action class="pl-2">
        ...
        <v-list-tile to="/encounter-runner" active-class="secondary--text">
          <v-list-tile-action class="pl-2">
...
export default {
  ...
  computed: {
    backButton() {
      return !['home', 'npc-list', 'encounter-builder', 'encounter-runner-list', 'about'].includes(
        this.$route.name
      )
    },
  },
