<template>
  <v-container fluid px-5>
        ...
        <v-card-text>
          <v-layout justify-center row>
            ...
            <v-flex xs4 class="effect-text text-xs-center ml-2 mr-2"
              >One Full Action <b>or</b> Two Quick Actions</v-flex
            >
            <v-flex xs2 class="effect-text text-xs-center ml-2 mr-2"
              >Overcharge</v-flex
            >
              ...
              <v-dialog width="50vw" style="height: 100%; width: 100%;">
                ...
                >
                  <v-toolbar
                    ...
                    dense
                    dark
                    :color="getColor(a.action_type, hover)"
                  >
                  ...
                  <v-card-text class="text-xs-left pt-2 pb-2"
                    ><p class="blockquote ma-0 pa-0" v-html="a.description"
                  /></v-card-text>
                </v-card>
            ...
            <v-card-text>
              ...
              <v-layout>
                <v-flex xs2
                  ...
                  ><v-icon large>mdi-dice-6</v-icon></v-flex
                >
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >Glancing Blow</span
                ...
                <v-flex xs7
                  ><span class="subheading"
                    ...
                    your mech is <b>impaired</b> until the end of your next
                    turn.</span
                  ></v-flex
                >
              </v-layout>
              ...
              <v-layout>
                <v-flex xs2
                  ...
                  ><v-icon large>mdi-minus</v-icon
                  ><v-icon large>mdi-dice-4</v-icon></v-flex
                >
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >System Trauma</span
                ...
                <v-flex xs7
                  ><span class="subheading"
                    >Parts of your mech are torn off by the damage. Roll a d6.
                    On a 1-3, all the weapons on one mount are destroyed. On a
                    4-6, a system is destroyed. You choose what’s destroyed, but
                    ...
                    destroy, this result becomes DIRECT HIT instead.</span
                  ></v-flex
                >
              </v-layout>
              <v-divider class="ma-2" />
              <v-layout>
                ...
                <v-flex xs7
                  ><span class="subheading"
                    ...
                    structure damage your mech has remaining.<br />
                    3+ - Your mech is <b>stunned</b> until the end of your next
                    turn.<br />
                    2 - Your mech must pass a <b>hull</b> save or be
                    <b>destroyed</b>.Even on a successful check, your mech is
                    <b>stunned</b> until the end of your next turn.<br />
                    1 or lower - Your mech is <b>destroyed</b>.</span
                  ></v-flex
                >
              </v-layout>
              <v-divider class="ma-2" />
              <v-layout>
                <v-flex xs2
                  ...
                  ><v-icon large>mdi-dice-1</v-icon></v-flex
                >
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >Crushing Hit</span
                ...
                <v-flex xs7
                  ><span class="subheading"
                    >Your mech is damaged beyond repair and is <b>destroyed</b>.
                    You can still exit it as normal.</span
                  ></v-flex
                >
              </v-layout>
            </v-card-text>
          ...
          <v-card>
            <v-card-text>
              ...
              <v-layout>
                ...
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >Emergency Shunt</span
                  ></v-flex
                >
                <v-flex xs7
                  ><span class="subheading"
                    >Cooling systems recover and manage to contain the peaking
                    heat levels. However, your mech is <b>impaired</b> until the
              ...
              <v-layout>
                ...
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >Power Plant Destabilize</span
                  ></v-flex
                >
                <v-flex xs7
                  ><span class="subheading"
                    >Your mech’s power plant becomes unstable, ejecting jets of
                    plasma. Your mech suffers from the <b>exposed</b> status
                    (taking double damage) until it takes action to remove
                    it.</span
                  ></v-flex
                >
              </v-layout>
              ...
              <v-layout>
                ...
                <v-flex xs7
                  ><span class="subheading"
                    >This result has different outcomes depending on how much
                    reactor stress your mech has remaining.<br />
                    ...
                    action and repeating this save.<br />
              ...
              <v-layout>
                ...
                <v-flex xs3
                  ><span class="subheading font-weight-bold text-uppercase"
                    >Irreversible Meltdown</span
                  ></v-flex
                >
                <v-flex xs7
                  ><span class="subheading"
                    >Your reactor goes critical. Your mech will suffer a reactor
                    meltdown at the end of your next turn..</span
                  ></v-flex
                >
              </v-layout>
              <v-divider class="ma-2" />
    ...
    <v-container class="effect-text">
      ...
      <v-layout>
        <p>
          <strong>Armor</strong> - The amount of damage you reduce all incoming
          sources of kinetic, energy, or explosive damage by. For mechs, armor
          cannot go higher than 4
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Electronic Defense</strong> - The number that most electronic
          warfare attacks must beat to be successful
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Evasion</strong> - The number that most melee and ranged
          attacks must beat in order to hit with an attack
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Grit</strong> - 1/2 your level. Added to melee and ranged
          attacks, system points, and hp
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Heat Capacity</strong> - The amount of heat your mech can take
          before any more heat will cause it to make an overheating check.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Hit Points (HP)</strong> - The amount of damage you can take
          as a pilot before going down and out, and the amount of damage a mech
          can take before it takes 1 point of structure damage.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Range</strong> - The range of your ranged attack, measured
          from yourself. Depends on weapon
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Repair Cap</strong> - The maximum number of repairs to your
          mech you can make per mission
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Resistance</strong> - Resistance to damage or a type of damage
          means it is reduced by half, rounded up, after armor is applied. You
          can only have resistance to damage once (it doesn&rsquo;t stack
          multiple times)
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Structure</strong> - When a character with structure goes to 0
          HP, it makes a structure check, then takes 1 structure damage. When a
          target runs out of structure, it either goes into the CRITICAL state
          (player mechs) or is destroyed outright.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Stress</strong> - When a character that can take stress
          overheats, it takes 1 stress then makes an overheating check.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Tech Attack</strong> - Electronic Warfare attacks, modified by
          your systems
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Threat</strong> - The range of your melee and overwatch
          attacks with certain weapons, measured from yourself. Base threat for
          all weapons is 1, but it may be greater depending on the weapon.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Sensor Range</strong> - The range in which you can make
          electronic warfare attacks, lock on, and use some systems. If a
          character is in your sensor range, you know about its existence unless
          it is hidden.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Size</strong> - The area that a character controls, rounded up
          for determining space. For example, a size 2 mech is an area 2 spaces
          on each side approximately 2 spaces high. Does not necessarily
          represent exact physical size.
        </p>
      </v-layout>
      <v-layout>
        <p>
          <strong>Speed</strong> - How far your mech moves when it moves (in
          spaces)
        </p>
      </v-layout>
    </v-container>
