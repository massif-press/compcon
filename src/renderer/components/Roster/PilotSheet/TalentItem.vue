<template>
  <v-expansion-panel-content>
    <v-toolbar-title slot="header" v-if="talentData.err">
      <span class="subheading grey--text">// MISSING DATA //</span>&emsp;<span v-if="talent.brew" class="caption grey--text">({{talent.brew}})</span>
    </v-toolbar-title>
      ...
      <v-card :color="isLocked(2) ? 'grey lighten-5' : ''">
        <v-card-title primary-title class="pb-0 pt-0 mb-0">
          <div>
            ...
            <p class="pl-4" v-html="talentData.r2_desc" />
          </div>
        </v-card-title>
      </v-card>
      <v-card :color="isLocked(3) ? 'grey lighten-5' : ''">
        <v-card-title primary-title class="pb-0 pt-0 mb-0">
          <div>
            ...
            <p class="pl-4" v-html="talentData.r3_desc" />
          </div>
        </v-card-title>
      </v-card>
    </div>
