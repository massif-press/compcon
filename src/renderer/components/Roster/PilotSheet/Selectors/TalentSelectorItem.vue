<template>
    <v-card>
        <v-card-text>
          ...
          <v-card hover>
            <v-card-title>
              <v-layout justify-space-between fill-height>
                ...
                <v-flex xs1>
                  <v-tooltip top :disabled="pointLimit || playerRank >= 1">
                    <div slot="activator" >
                    ...
                    <span> Learn {{talent.name}} Rank I: {{talent.r1_name}}</span>
                  </v-tooltip>
                </v-flex>
              </v-layout>
            </v-card-title>
          ...
          <v-card hover :color="!playerRank || newPilot ? 'grey lighten-5' : ''">
            <v-card-title>
              <v-layout justify-space-between fill-height>
                <v-flex xs10>
                ...
                <v-flex xs1>
                  <v-tooltip top :disabled="pointLimit || playerRank !== 1 || newPilot">
                    <div slot="activator">
                    ...
                    <span> Learn {{talent.name}} Rank II: {{talent.r2_name}}</span>
                  </v-tooltip>
                </v-flex>
              </v-layout>
            </v-card-title>
          ...
          <v-card hover :color="playerRank < 2 ? 'grey lighten-5' : ''">
            <v-card-title>
              <v-layout justify-space-between fill-height>
                <v-flex xs10>
                ...
                <v-flex xs1>
                  <v-tooltip top :disabled="pointLimit || playerRank !== 2">
                    <div slot="activator">
                    ...
                    <span> Learn {{talent.name}} Rank III: {{talent.r3_name}}</span>
                  </v-tooltip>
                </v-flex>
              </v-layout>
            </v-card-title>
