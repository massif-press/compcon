    ...
    <div id="wrapper">
        ...
        <v-container>
            <v-layout style="height: 100%" align-v="center" class="mt-5">
                <v-flex>
                    <v-btn block color="primary" large to="/roster">Pilot Roster</v-btn>
                </v-flex>
                <v-flex>
                ...
                <v-flex>
                    <v-tooltip bottom>
                        <v-btn slot="activator" block large :to="'/mods'" disabled>Mod Editor</v-btn>
                        <span>WIP</span>
                    </v-tooltip>
                </v-flex>
                <v-flex>
                ...
                <v-flex>
                    <v-card>
                        <v-card-title class="title">
                            Update MM/DD/YYYY
                            <span class="caption">(v0.2.1)</span>
                        </v-card-title>
