...
class WeaponProfile extends CompendiumItem {
  public readonly Parent: MechWeapon
  ...
  public Cost: number
  public Skirmish: boolean
  public Barrage: boolean
  ...
  public get Attack(): 'ranged' | 'melee' | 'tech' {
    ...
    if (this.Parent.WeaponTypes.includes(WeaponType.Melee)) return 'melee'
    return 'ranged'
  }
...
export { MechWeapon, WeaponProfile }
