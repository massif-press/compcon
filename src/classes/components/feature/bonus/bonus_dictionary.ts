export const BonusId = {
  ...
  HULL_SAVE: 'hull_save',
  AGILITY: 'agility',
  AGILITY_CHECK: 'agility_check',
  AGILITY_SAVE: 'agility_save',
  SYSTEMS: 'systems',
  SYSTEMS_CHECK: 'systems_check',
  SYSTEMS_SAVE: 'systems_save',
  ENGINEERING: 'engineering',
  ENGINEERING_CHECK: 'engineering_check',
  ENGINEERING_SAVE: 'engineering_save',
  CHECK: 'check',
  THREAT: 'threat',
  ADD_WEAPON_TYPE: 'add_weapon_type',
  SET_WEAPON_TYPE: 'set_weapon_type',
  GRAPPLE: 'grapple',
  RAM: 'ram',
  SIZES: 'sizes',
  MELEE: 'melee',
...
const _coreEntries: IBonusMeta[] = [
  ...
  },
  {
    id: 'hp',
    title: 'HP',
    detail: '{INC_DEC} total Hit Points by {VAL}',
  },
  {
    id: 'armor',
    title: 'Armor',
    detail: '{INC_DEC} total Armor by {VAL}',
  },
  {
    id: 'structure',
    title: 'Structure',
    detail: '{INC_DEC} total Structure by {VAL}',
  },
  {
    id: 'stress',
    title: 'Reactor Stress',
    detail: '{INC_DEC} total Reactor Stress by {VAL}',
  },
  {
    id: 'heatcap',
    title: 'Heat Capacity',
    detail: '{INC_DEC} total Heat Capacity by {VAL}',
  },
  {
    id: 'repcap',
    title: 'Repair Capacity',
    detail: '{INC_DEC} total Repair Capacity by {VAL}',
  },
  {
    id: 'core_power',
    title: 'CORE Power',
    detail: '{INC_DEC} total CORE Power by {VAL}',
  },
  {
    id: 'speed',
    title: 'Speed',
    detail: '{INC_DEC} total Speed by {VAL}',
  },
  {
    id: 'evasion',
    title: 'Evasion',
    detail: '{INC_DEC} total Evasion by {VAL}',
  },
  {
    id: 'edef',
    title: 'E-Defense',
    detail: '{INC_DEC} total E-Defense by {VAL}',
  },
  {
    id: 'sensor',
    title: 'Sensor Range',
    detail: '{INC_DEC} total Sensor Range by {VAL}',
  },
  {
    id: 'tech_attack',
    title: 'Tech Attack',
    detail: '{INC_DEC} total Tech Attack by {VAL}',
  },
  {
    id: 'save',
    title: 'Save',
    detail: '{INC_DEC} total Save by {VAL}',
  },
  {
    id: 'sp',
    title: 'SP',
    detail: '{INC_DEC} total System Points by {VAL}',
  },
  {
    id: 'size',
    title: 'Modified Size',
    detail: '{INC_DEC} Size by {VAL}',
  },
  {
    id: 'ai_cap',
    title: 'AI Capacity',
    detail: '{INC_DEC} total AI Capacity by {VAL}',
  },
  {
    id: 'cheap_struct',
  ...
  {
    id: 'deploy_count',
    title: 'Deployable Count',
    detail: 'Deploy {Val} additional Deployables per deploy action',
  },
  {
    id: 'drone_hp',
  ...
  },
  {
    id: 'activations',
    title: 'Activations',
    detail: 'Take {VAL} additional turns per round',
  },
  {
    id: 'activations_pct',
    title: 'Activations Per Player',
    detail:
  ...
  { id: 'hull', title: 'Hull', detail: '{INC_DEC} Hull Check and Save rolls by {VAL}' },
  { id: 'hull_check', title: 'Hull', detail: '{INC_DEC} Hull Check rolls by {VAL}' },
  { id: 'hull_save', title: 'Hull', detail: '{INC_DEC} Hull Save rolls by {VAL}' },
  {
    id: 'agility',
    title: 'Agility',
  ...
  },
  {
    id: 'agility_check',
    title: 'Agility',
    detail: '{INC_DEC} Agility Check rolls by {VAL}',
  },
  {
    id: 'agility_save',
    title: 'Agility',
    detail: '{INC_DEC} Agility Save rolls by {VAL}',
  },
  {
    id: 'systems',
    title: 'Systems',
  ...
  },
  {
    id: 'systems_check',
    title: 'Systems',
    detail: '{INC_DEC} Systems Check rolls by {VAL}',
  },
  {
    id: 'systems_save',
    title: 'Systems',
    detail: '{INC_DEC} Systems Save rolls by {VAL}',
  },
  {
    id: 'engineering',
    title: 'Engineering',
  ...
  },
  {
    ...
    title: 'Engineering',
    detail: '{INC_DEC} Engineering Check rolls by {VAL}',
  },
  {
    id: 'engineering_save',
    title: 'Engineering',
    detail: '{INC_DEC} Engineering Save rolls by {VAL}',
  },
