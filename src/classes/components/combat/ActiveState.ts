...
import { IDeployableData, IDeployedData } from '../feature/deployable/Deployable'
...
class ActiveState {
  ...
  public static Deserialize(pilot: PilotInstance, data: IActiveStateData): ActiveState {
